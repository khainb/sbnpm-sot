...
np.save('saved/SMixW_L{}.npy'.format(L), matrices)
...
np.savetxt('saved/Zs_SMixW_L{}.txt'.format(L), Z.reshape(1, -1), delimiter=',', fmt="%d")
...
np.save('saved/SMixW_TV_L{}.npy'.format(L), np.array(TV))
np.save('saved/SMixW_SW_L{}.npy'.format(L), np.array(W2))
